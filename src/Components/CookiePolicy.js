	...
	return (
		<div className="pageContainer">
			<div className="cookie-text">
				<h1 className="adsimple-312016962">Datenschutzerklärung</h1>
				<h2 id="einleitung-ueberblick" className="adsimple-312016962">Einleitung und Überblick</h2>
				<p>Wir haben diese Datenschutzerklärung (Fassung 07.05.2022-312016962) verfasst, um Ihnen gemäß der Vorgaben der <a className="adsimple-312016962" href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&#038;from=DE&#038;tid=312016962#d1e2269-1-1" target="_blank" rel="noopener noreferrer">Datenschutz-Grundverordnung (EU) 2016/679</a> und anwendbaren nationalen Gesetzen zu erklären, welche personenbezogenen Daten (kurz Daten) wir als Verantwortliche &#8211; und die von uns beauftragten Auftragsverarbeiter (z. B. Provider) &#8211; verarbeiten, zukünftig verarbeiten werden und welche rechtmäßigen Möglichkeiten Sie haben. Die verwendeten Begriffe sind geschlechtsneutral zu verstehen.<br />
					<strong className="adsimple-312016962">Kurz gesagt:</strong> Wir informieren Sie umfassend über Daten, die wir über Sie verarbeiten.</p>
				<p>Datenschutzerklärungen klingen für gewöhnlich sehr technisch und verwenden juristische Fachbegriffe. Diese Datenschutzerklärung soll Ihnen hingegen die wichtigsten Dinge so einfach und transparent wie möglich beschreiben. Soweit es der Transparenz förderlich ist, werden technische <strong className="adsimple-312016962">Begriffe leserfreundlich erklärt</strong>, <strong className="adsimple-312016962">Links</strong> zu weiterführenden Informationen geboten und <strong className="adsimple-312016962">Grafiken</strong> zum Einsatz gebracht. Wir informieren damit in klarer und einfacher Sprache, dass wir im Rahmen unserer Geschäftstätigkeiten nur dann personenbezogene Daten verarbeiten, wenn eine entsprechende gesetzliche Grundlage gegeben ist. Das ist sicher nicht möglich, wenn man möglichst knappe, unklare und juristisch-technische Erklärungen abgibt, so wie sie im Internet oft Standard sind, wenn es um Datenschutz geht. Ich hoffe, Sie finden die folgenden Erläuterungen interessant und informativ und vielleicht ist die eine oder andere Information dabei, die Sie noch nicht kannten.<br />
				...
				<h2 id="anwendungsbereich" className="adsimple-312016962">Anwendungsbereich</h2>
				<p>Diese Datenschutzerklärung gilt für alle von uns im Unternehmen verarbeiteten personenbezogenen Daten und für alle personenbezogenen Daten, die von uns beauftragte Firmen (Auftragsverarbeiter) verarbeiten. Mit personenbezogenen Daten meinen wir Informationen im Sinne des Art. 4 Nr. 1 DSGVO wie zum Beispiel Name, E-Mail-Adresse und postalische Anschrift einer Person. Die Verarbeitung personenbezogener Daten sorgt dafür, dass wir unsere Dienstleistungen und Produkte anbieten und abrechnen können, sei es online oder offline. Der Anwendungsbereich dieser Datenschutzerklärung umfasst:</p>
				<ul className="adsimple-312016962">
					<li className="adsimple-312016962">alle Onlineauftritte (Websites, Onlineshops), die wir betreiben</li>
					<li className="adsimple-312016962">Social Media Auftritte und E-Mail-Kommunikation</li>
					<li className="adsimple-312016962">mobile Apps für Smartphones und andere Geräte</li>
				</ul>
				<p>
					<strong className="adsimple-312016962">Kurz gesagt:</strong> Die Datenschutzerklärung gilt für alle Bereiche, in denen personenbezogene Daten im Unternehmen über die genannten Kanäle strukturiert verarbeitet werden. Sollten wir außerhalb dieser Kanäle mit Ihnen in Rechtsbeziehungen eintreten, werden wir Sie gegebenenfalls gesondert informieren.</p>
				<h2 id="rechtsgrundlagen" className="adsimple-312016962">Rechtsgrundlagen</h2>
				<p>In der folgenden Datenschutzerklärung geben wir Ihnen transparente Informationen zu den rechtlichen Grundsätzen und Vorschriften, also den Rechtsgrundlagen der Datenschutz-Grundverordnung, die uns ermöglichen, personenbezogene Daten zu verarbeiten.<br />
					Was das EU-Recht betrifft, beziehen wir uns auf die VERORDNUNG (EU) 2016/679 DES EUROPÄISCHEN PARLAMENTS UND DES RATES vom 27. April 2016. Diese Datenschutz-Grundverordnung der EU können Sie selbstverständlich online auf EUR-Lex, dem Zugang zum EU-Recht, unter <a className="adsimple-312016962" href="https://eur-lex.europa.eu/legal-content/DE/ALL/?uri=celex%3A32016R0679&amp;tid=312016962" target="_blank" rel="noopener noreferrer">https://eur-lex.europa.eu/legal-content/DE/TXT/?uri=celex%3A32016R0679</a> nachlesen.</p>
				<p>Wir verarbeiten Ihre Daten nur, wenn mindestens eine der folgenden Bedingungen zutrifft:</p>
				<ol>
					<li className="adsimple-312016962">
						<strong className="adsimple-312016962">Einwilligung</strong> (Artikel 6 Absatz 1 lit. a DSGVO): Sie haben uns Ihre Einwilligung gegeben, Daten zu einem bestimmten Zweck zu verarbeiten. Ein Beispiel wäre die Speicherung Ihrer eingegebenen Daten eines Kontaktformulars.</li>
					<li className="adsimple-312016962">
						<strong className="adsimple-312016962">Vertrag</strong> (Artikel 6 Absatz 1 lit. b DSGVO): Um einen Vertrag oder vorvertragliche Verpflichtungen mit Ihnen zu erfüllen, verarbeiten wir Ihre Daten. Wenn wir zum Beispiel einen Kaufvertrag mit Ihnen abschließen, benötigen wir vorab personenbezogene Informationen.</li>
					<li className="adsimple-312016962">
						<strong className="adsimple-312016962">Rechtliche Verpflichtung</strong> (Artikel 6 Absatz 1 lit. c DSGVO): Wenn wir einer rechtlichen Verpflichtung unterliegen, verarbeiten wir Ihre Daten. Zum Beispiel sind wir gesetzlich verpflichtet Rechnungen für die Buchhaltung aufzuheben. Diese enthalten in der Regel personenbezogene Daten.</li>
					<li className="adsimple-312016962">
						<strong className="adsimple-312016962">Berechtigte Interessen</strong> (Artikel 6 Absatz 1 lit. f DSGVO): Im Falle berechtigter Interessen, die Ihre Grundrechte nicht einschränken, behalten wir uns die Verarbeitung personenbezogener Daten vor. Wir müssen zum Beispiel gewisse Daten verarbeiten, um unsere Website sicher und wirtschaftlich effizient betreiben zu können. Diese Verarbeitung ist somit ein berechtigtes Interesse.</li>
				</ol>
				<p>Weitere Bedingungen wie die Wahrnehmung von Aufnahmen im öffentlichen Interesse und Ausübung öffentlicher Gewalt sowie dem Schutz lebenswichtiger Interessen treten bei uns in der Regel nicht auf. Soweit eine solche Rechtsgrundlage doch einschlägig sein sollte, wird diese an der entsprechenden Stelle ausgewiesen.</p>
				<p>Zusätzlich zu der EU-Verordnung gelten auch noch nationale Gesetze:</p>
				<ul className="adsimple-312016962">
					<li className="adsimple-312016962">In <strong className="adsimple-312016962">Österreich</strong> ist dies das Bundesgesetz zum Schutz natürlicher Personen bei der Verarbeitung personenbezogener Daten (<strong className="adsimple-312016962">Datenschutzgesetz</strong>), kurz <strong className="adsimple-312016962">DSG</strong>.</li>
					<li className="adsimple-312016962">In <strong className="adsimple-312016962">Deutschland</strong> gilt das <strong className="adsimple-312016962">Bundesdatenschutzgesetz</strong>, kurz<strong className="adsimple-312016962"> BDSG</strong>.</li>
				</ul>
				<p>Sofern weitere regionale oder nationale Gesetze zur Anwendung kommen, informieren wir Sie in den folgenden Abschnitten darüber.</p>
				<h2 id="speicherdauer" className="adsimple-312016962">Speicherdauer</h2>
				...
				<h2 id="rechte-dsgvo" className="adsimple-312016962">Rechte laut Datenschutz-Grundverordnung</h2>
				...
				<ul className="adsimple-312016962">
					<li className="adsimple-312016962">Sie haben laut Artikel 15 DSGVO ein Auskunftsrecht darüber, ob wir Daten von Ihnen verarbeiten. Sollte das zutreffen, haben Sie Recht darauf eine Kopie der Daten zu erhalten und die folgenden Informationen zu erfahren:
						<ul className="adsimple-312016962">
							<li className="adsimple-312016962">zu welchem Zweck wir die Verarbeitung durchführen;</li>
							<li className="adsimple-312016962">die Kategorien, also die Arten von Daten, die verarbeitet werden;</li>
							<li className="adsimple-312016962">wer diese Daten erhält und wenn die Daten an Drittländer übermittelt werden, wie die Sicherheit garantiert werden kann;</li>
							<li className="adsimple-312016962">wie lange die Daten gespeichert werden;</li>
							<li className="adsimple-312016962">das Bestehen des Rechts auf Berichtigung, Löschung oder Einschränkung der Verarbeitung und dem Widerspruchsrecht gegen die Verarbeitung;</li>
							<li className="adsimple-312016962">dass Sie sich bei einer Aufsichtsbehörde beschweren können (Links zu diesen Behörden finden Sie weiter unten);</li>
							<li className="adsimple-312016962">die Herkunft der Daten, wenn wir sie nicht bei Ihnen erhoben haben;</li>
							<li className="adsimple-312016962">ob Profiling durchgeführt wird, ob also Daten automatisch ausgewertet werden, um zu einem persönlichen Profil von Ihnen zu gelangen.</li>
						</ul>
					</li>
					<li className="adsimple-312016962">Sie haben laut Artikel 16 DSGVO ein Recht auf Berichtigung der Daten, was bedeutet, dass wir Daten richtig stellen müssen, falls Sie Fehler finden.</li>
					<li className="adsimple-312016962">Sie haben laut Artikel 17 DSGVO das Recht auf Löschung („Recht auf Vergessenwerden“), was konkret bedeutet, dass Sie die Löschung Ihrer Daten verlangen dürfen.</li>
					<li className="adsimple-312016962">Sie haben laut Artikel 18 DSGVO das Recht auf Einschränkung der Verarbeitung, was bedeutet, dass wir die Daten nur mehr speichern dürfen aber nicht weiter verwenden.</li>
					<li className="adsimple-312016962">Sie haben laut Artikel 19 DSGVO das Recht auf Datenübertragbarkeit, was bedeutet, dass wir Ihnen auf Anfrage Ihre Daten in einem gängigen Format zur Verfügung stellen.</li>
					<li className="adsimple-312016962">Sie haben laut Artikel 21 DSGVO ein Widerspruchsrecht, welches nach Durchsetzung eine Änderung der Verarbeitung mit sich bringt.
						<ul className="adsimple-312016962">
							<li className="adsimple-312016962">Wenn die Verarbeitung Ihrer Daten auf Artikel 6 Abs. 1 lit. e (öffentliches Interesse, Ausübung öffentlicher Gewalt) oder Artikel 6 Abs. 1 lit. f (berechtigtes Interesse) basiert, können Sie gegen die Verarbeitung Widerspruch einlegen. Wir prüfen danach so rasch wie möglich, ob wir diesem Widerspruch rechtlich nachkommen können.</li>
							<li className="adsimple-312016962">Werden Daten verwendet, um Direktwerbung zu betreiben, können Sie jederzeit gegen diese Art der Datenverarbeitung widersprechen. Wir dürfen Ihre Daten danach nicht mehr für Direktmarketing verwenden.</li>
							<li className="adsimple-312016962">Werden Daten verwendet, um Profiling zu betreiben, können Sie jederzeit gegen diese Art der Datenverarbeitung widersprechen. Wir dürfen Ihre Daten danach nicht mehr für Profiling verwenden.</li>
						</ul>
					</li>
					<li className="adsimple-312016962">Sie haben laut Artikel 22 DSGVO unter Umständen das Recht, nicht einer ausschließlich auf einer automatisierten Verarbeitung (zum Beispiel Profiling) beruhenden Entscheidung unterworfen zu werden.</li>
					<li className="adsimple-312016962">Sie haben laut Artikel 77 DSGVO das Recht auf Beschwerde. Das heißt, Sie können sich jederzeit bei der Datenschutzbehörde beschweren, wenn Sie der Meinung sind, dass die Datenverarbeitung von personenbezogenen Daten gegen die DSGVO verstößt.</li>
				</ul>
				<p>
					<strong className="adsimple-312016962">Kurz gesagt:</strong> Sie haben Rechte &#8211; zögern Sie nicht, die oben gelistete verantwortliche Stelle bei uns zu kontaktieren!</p>
				<p>Wenn Sie glauben, dass die Verarbeitung Ihrer Daten gegen das Datenschutzrecht verstößt oder Ihre datenschutzrechtlichen Ansprüche in sonst einer Weise verletzt worden sind, können Sie sich bei der Aufsichtsbehörde beschweren. Diese ist für Österreich die Datenschutzbehörde, deren Website Sie unter <a className="adsimple-312016962" href="https://www.dsb.gv.at/?tid=312016962" target="_blank" rel="noopener noreferrer">https://www.dsb.gv.at/</a> finden. In Deutschland gibt es für jedes Bundesland einen Datenschutzbeauftragten. Für nähere Informationen können Sie sich an die <a className="adsimple-312016962" href="https://www.bfdi.bund.de/DE/Home/home_node.html" target="_blank" rel="noopener noreferrer">Bundesbeauftragte für den Datenschutz und die Informationsfreiheit (BfDI)</a> wenden. Für unser Unternehmen ist die folgende lokale Datenschutzbehörde zuständig:</p>
				<h2 id="datenuebertragung-drittlaender" className="adsimple-312016962">Datenübertragung in Drittländer</h2>
				...
				<h2 id="cookies" className="adsimple-312016962">Cookies</h2>
				<table border="1" cellPadding="15">
					<tbody>
						<tr>
							<td>
								<strong className="adsimple-312016962">Cookies Zusammenfassung</strong>
								<br />
				...
				<h3 className="adsimple-312016962">Was sind Cookies?</h3>
				...
				<p>
					<strong className="adsimple-312016962">Name:</strong> _ga<br />
					<strong className="adsimple-312016962">Wert:</strong> GA1.2.1326744211.152312016962-9<br />
					<strong className="adsimple-312016962">Verwendungszweck:</strong> Unterscheidung der Websitebesucher<br />
					<strong className="adsimple-312016962">Ablaufdatum:</strong> nach 2 Jahren</p>
				<p>Diese Mindestgrößen sollte ein Browser unterstützen können:</p>
				<ul className="adsimple-312016962">
					<li className="adsimple-312016962">Mindestens 4096 Bytes pro Cookie</li>
					<li className="adsimple-312016962">Mindestens 50 Cookies pro Domain</li>
					<li className="adsimple-312016962">Mindestens 3000 Cookies insgesamt</li>
				</ul>
				<h3 className="adsimple-312016962">Welche Arten von Cookies gibt es?</h3>
				<p>Die Frage welche Cookies wir im Speziellen verwenden, hängt von den verwendeten Diensten ab und wird in den folgenden Abschnitten der Datenschutzerklärung geklärt. An dieser Stelle möchten wir kurz auf die verschiedenen Arten von HTTP-Cookies eingehen.</p>
				<p>Man kann 4 Arten von Cookies unterscheiden:</p>
				<p>
					<strong className="adsimple-312016962">Unerlässliche Cookies<br />
				...
				<p>
					<strong className="adsimple-312016962">Zweckmäßige Cookies<br />
				...
				<p>
					<strong className="adsimple-312016962">Zielorientierte Cookies<br />
					</strong>Diese Cookies sorgen für eine bessere Nutzerfreundlichkeit. Beispielsweise werden eingegebene Standorte, Schriftgrößen oder Formulardaten gespeichert.</p>
				<p>
					<strong className="adsimple-312016962">Werbe-Cookies<br />
					</strong>Diese Cookies werden auch Targeting-Cookies genannt. Sie dienen dazu dem User individuell angepasste Werbung zu liefern. Das kann sehr praktisch, aber auch sehr nervig sein.</p>
				<p>Üblicherweise werden Sie beim erstmaligen Besuch einer Website gefragt, welche dieser Cookiearten Sie zulassen möchten. Und natürlich wird diese Entscheidung auch in einem Cookie gespeichert.</p>
				<p>Wenn Sie mehr über Cookies wissen möchten und technische Dokumentationen nicht scheuen, empfehlen wir <a className="adsimple-312016962" href="https://datatracker.ietf.org/doc/html/rfc6265">https://datatracker.ietf.org/doc/html/rfc6265</a>, dem Request for Comments der Internet Engineering Task Force (IETF) namens &#8220;HTTP State Management Mechanism&#8221;.</p>
				<h3 className="adsimple-312016962">Zweck der Verarbeitung über Cookies</h3>
				...
				<h3 className="adsimple-312016962">Welche Daten werden verarbeitet?</h3>
				...
				<h3 className="adsimple-312016962">Speicherdauer von Cookies</h3>
				<p>Die Speicherdauer hängt vom jeweiligen Cookie ab und wird weiter unter präzisiert. Manche Cookies werden nach weniger als einer Stunde gelöscht, andere können mehrere Jahre auf einem Computer gespeichert bleiben.</p>
				<p>Sie haben außerdem selbst Einfluss auf die Speicherdauer. Sie können über ihren Browser sämtliche Cookies jederzeit manuell löschen (siehe auch unten &#8220;Widerspruchsrecht&#8221;). Ferner werden Cookies, die auf einer Einwilligung beruhen, spätestens nach Widerruf Ihrer Einwilligung gelöscht, wobei die Rechtmäßigkeit der Speicherung bis dahin unberührt bleibt.</p>
				<h3 className="adsimple-312016962">Widerspruchsrecht &#8211; wie kann ich Cookies löschen?</h3>
				<p>Wie und ob Sie Cookies verwenden wollen, entscheiden Sie selbst. Unabhängig von welchem Service oder welcher Website die Cookies stammen, haben Sie immer die Möglichkeit Cookies zu löschen, zu deaktivieren oder nur teilweise zuzulassen. Zum Beispiel können Sie Cookies von Drittanbietern blockieren, aber alle anderen Cookies zulassen.</p>
				<p>Wenn Sie feststellen möchten, welche Cookies in Ihrem Browser gespeichert wurden, wenn Sie Cookie-Einstellungen ändern oder löschen wollen, können Sie dies in Ihren Browser-Einstellungen finden:</p>
				<p>
					<a className="adsimple-312016962" href="https://support.google.com/chrome/answer/95647?tid=312016962" target="_blank" rel="noopener noreferrer">Chrome: Cookies in Chrome löschen, aktivieren und verwalten</a>
				</p>
				<p>
					<a className="adsimple-312016962" href="https://support.apple.com/de-at/guide/safari/sfri11471/mac?tid=312016962" target="_blank" rel="noopener noreferrer">Safari: Verwalten von Cookies und Websitedaten mit Safari</a>
				</p>
				<p>
					<a className="adsimple-312016962" href="https://support.mozilla.org/de/kb/cookies-und-website-daten-in-firefox-loschen?tid=312016962" target="_blank" rel="noopener noreferrer">Firefox: Cookies löschen, um Daten zu entfernen, die Websites auf Ihrem Computer abgelegt haben</a>
				</p>
				<p>
					<a className="adsimple-312016962" href="https://support.microsoft.com/de-de/windows/l%C3%B6schen-und-verwalten-von-cookies-168dab11-0753-043d-7c16-ede5947fc64d?tid=312016962">Internet Explorer: Löschen und Verwalten von Cookies</a>
				</p>
				<p>
					<a className="adsimple-312016962" href="https://support.microsoft.com/de-de/microsoft-edge/cookies-in-microsoft-edge-l%C3%B6schen-63947406-40ac-c3b8-57b9-2a946a29ae09?tid=312016962">Microsoft Edge: Löschen und Verwalten von Cookies</a>
				</p>
				<p>Falls Sie grundsätzlich keine Cookies haben wollen, können Sie Ihren Browser so einrichten, dass er Sie immer informiert, wenn ein Cookie gesetzt werden soll. So können Sie bei jedem einzelnen Cookie entscheiden, ob Sie das Cookie erlauben oder nicht. Die Vorgangsweise ist je nach Browser verschieden. Am besten Sie suchen die Anleitung in Google mit dem Suchbegriff “Cookies löschen Chrome” oder &#8220;Cookies deaktivieren Chrome&#8221; im Falle eines Chrome Browsers.</p>
				<h3 className="adsimple-312016962">Rechtsgrundlage</h3>
				<p>Seit 2009 gibt es die sogenannten „Cookie-Richtlinien“. Darin ist festgehalten, dass das Speichern von Cookies eine <strong className="adsimple-312016962">Einwilligung</strong> (Artikel 6 Abs. 1 lit. a DSGVO) von Ihnen verlangt. Innerhalb der EU-Länder gibt es allerdings noch sehr unterschiedliche Reaktionen auf diese Richtlinien. In Österreich erfolgte aber die Umsetzung dieser Richtlinie in § 96 Abs. 3 des Telekommunikationsgesetzes (TKG). In Deutschland wurden die Cookie-Richtlinien nicht als nationales Recht umgesetzt. Stattdessen erfolgte die Umsetzung dieser Richtlinie weitgehend in § 15 Abs.3 des Telemediengesetzes (TMG).</p>
				<p>Für unbedingt notwendige Cookies, auch soweit keine Einwilligung vorliegt, bestehen <strong className="adsimple-312016962">berechtigte Interessen</strong> (Artikel 6 Abs. 1 lit. f DSGVO), die in den meisten Fällen wirtschaftlicher Natur sind. Wir möchten den Besuchern der Website eine angenehme Benutzererfahrung bescheren und dafür sind bestimmte Cookies oft unbedingt notwendig.</p>
				<p>Soweit nicht unbedingt erforderliche Cookies zum Einsatz kommen, geschieht dies nur im Falle Ihrer Einwilligung. Rechtsgrundlage ist insoweit Art. 6 Abs. 1 lit. a DSGVO.</p>
				<p>In den folgenden Abschnitten werden Sie genauer über den Einsatz von Cookies informiert, sofern eingesetzte Software Cookies verwendet.</p>
				<h2 id="webhosting-einleitung" className="adsimple-312016962">Webhosting Einleitung</h2>
				<table border="1" cellPadding="15">
					<tbody>
						<tr>
							<td>
								<strong className="adsimple-312016962">Webhosting Zusammenfassung</strong>
								<br />
								&#x1f465; Betroffene: Besucher der Website<br />
				...
				<h3 className="adsimple-312016962">Was ist Webhosting?</h3>
				...
				<h3 className="adsimple-312016962">Warum verarbeiten wir personenbezogene Daten?</h3>
				<p>Die Zwecke der Datenverarbeitung sind:</p>
				<ol>
					<li className="adsimple-312016962">Professionelles Hosting der Website und Absicherung des Betriebs</li>
					<li className="adsimple-312016962">zur Aufrechterhaltung der Betriebs- und IT-Sicherheit</li>
					<li className="adsimple-312016962">Anonyme Auswertung des Zugriffsverhaltens zur Verbesserung unseres Angebots und ggf. zur Strafverfolgung bzw. Verfolgung von Ansprüchen</li>
				</ol>
				<h3 className="adsimple-312016962">Welche Daten werden verarbeitet?</h3>
				<p>Auch während Sie unsere Website jetzt gerade besuchen, speichert unser Webserver, das ist der Computer auf dem diese Webseite gespeichert ist, in der Regel automatisch Daten wie</p>
				<ul className="adsimple-312016962">
					<li className="adsimple-312016962">die komplette Internetadresse (URL) der aufgerufenen Webseite</li>
					<li className="adsimple-312016962">Browser und Browserversion (z. B. Chrome 87)</li>
					<li className="adsimple-312016962">das verwendete Betriebssystem (z. B. Windows 10)</li>
					<li className="adsimple-312016962">die Adresse (URL) der zuvor besuchten Seite (Referrer URL) (z. B. <a className="adsimple-312016962" href="https://www.beispielquellsite.de/vondabinichgekommen.html/" target="_blank" rel="follow noreferrer noopener">https://www.beispielquellsite.de/vondabinichgekommen.html/</a>)</li>
					<li className="adsimple-312016962">den Hostnamen und die IP-Adresse des Geräts von welchem aus zugegriffen wird (z. B. COMPUTERNAME und 194.23.43.121)</li>
					<li className="adsimple-312016962">Datum und Uhrzeit</li>
					<li className="adsimple-312016962">in Dateien, den sogenannten Webserver-Logfiles</li>
				</ul>
				<h3 className="adsimple-312016962">Wie lange werden Daten gespeichert?</h3>
				<p>In der Regel werden die oben genannten Daten zwei Wochen gespeichert und danach automatisch gelöscht. Wir geben diese Daten nicht weiter, können jedoch nicht ausschließen, dass diese Daten beim Vorliegen von rechtswidrigem Verhalten von Behörden eingesehen werden.</p>
				<p>
					<strong className="adsimple-312016962">Kurz gesagt:</strong> Ihr Besuch wird durch unseren Provider (Firma, die unsere Website auf speziellen Computern (Servern) laufen lässt), protokolliert, aber wir geben Ihre Daten nicht ohne Zustimmung weiter!</p>
				<h3 className="adsimple-312016962">Rechtsgrundlage</h3>
				...
				<h2 id="social-media-einleitung" className="adsimple-312016962">Social Media Einleitung</h2>
				<table border="1" cellPadding="15">
					<tbody>
						<tr>
							<td>
								<strong className="adsimple-312016962">Social Media Datenschutzerklärung Zusammenfassung</strong>
								<br />
								&#x1f465; Betroffene: Besucher der Website<br />
				...
				<h3 className="adsimple-312016962">Was ist Social Media?</h3>
				...
				<h3 className="adsimple-312016962">Warum nutzen wir Social Media?</h3>
				...
				<h3 className="adsimple-312016962">
					<span className="adsimple-312016962" data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;Wo und wie lange werden Daten gespeichert?&quot;}" data-sheets-userformat="{&quot;2&quot;:769,&quot;3&quot;:{&quot;1&quot;:0},&quot;11&quot;:4,&quot;12&quot;:0}">Dauer der Datenverarbeitung</span>
				</h3>
				...
				<h3 className="adsimple-312016962">Widerspruchsrecht</h3>
				...
				<h3 className="adsimple-312016962">Rechtsgrundlage</h3>
				<p>Wenn Sie eingewilligt haben, dass Daten von Ihnen durch eingebundene Social-Media-Elemente verarbeitet und gespeichert werden können, gilt diese Einwilligung als Rechtsgrundlage der Datenverarbeitung <strong className="adsimple-312016962">(Art. 6 Abs. 1 lit. a DSGVO)</strong>. Grundsätzlich werden Ihre Daten bei Vorliegen einer Einwilligung auch auf Grundlage unseres berechtigten Interesses <strong className="adsimple-312016962">(Art. 6 Abs. 1 lit. f DSGVO)</strong> an einer schnellen und guten Kommunikation mit Ihnen oder anderen Kunden und Geschäftspartnern gespeichert und verarbeitet. Wir setzen die Tools gleichwohl nur ein, soweit Sie eine Einwilligung erteilt haben. Die meisten Social-Media-Plattformen setzen auch Cookies in Ihrem Browser, um Daten zu speichern. Darum empfehlen wir Ihnen, unseren Datenschutztext über Cookies genau durchzulesen und die Datenschutzerklärung oder die Cookie-Richtlinien des jeweiligen Dienstanbieters anzusehen.</p>
				<p>Informationen zu speziellen Social-Media-Plattformen erfahren Sie &#8211; sofern vorhanden &#8211; in den folgenden Abschnitten.</p>
				<h2 id="twitter-datenschutzerklaerung" className="adsimple-312016962">Twitter Datenschutzerklärung</h2>
				<table border="1" cellPadding="15">
					<tbody>
						<tr>
							<td>
								<strong className="adsimple-312016962">Twitter Datenschutzerklärung Zusammenfassung</strong>
								<br />
								&#x1f465; Betroffene: Besucher der Website<br />
				...
				<h3 className="adsimple-312016962">Was ist Twitter?</h3>
				...
				<h3 className="adsimple-312016962">Warum verwenden wir Twitter auf unserer Website?</h3>
				...
				<h3 className="adsimple-312016962">Welche Daten werden von Twitter gespeichert?</h3>
				...
				<p>
					<strong className="adsimple-312016962">Name:</strong> personalization_id<br />
					<strong className="adsimple-312016962">Wert:</strong> &#8220;v1_cSJIsogU51SeE312016962&#8221;<br />
					<strong className="adsimple-312016962">Verwendungszweck: </strong>Dieses Cookie speichert Informationen darüber, wie Sie die Webseite nutzen und über welche Werbung Sie möglicherweise zu Twitter gekommen sind.<br />
					<strong className="adsimple-312016962">Ablaufdatum:</strong> nach 2 Jahren</p>
				<p>
					<strong className="adsimple-312016962">Name: </strong>lang<br />
					<strong className="adsimple-312016962">Wert: </strong>de<br />
					<strong className="adsimple-312016962">Verwendungszweck: </strong>Dieses Cookie speichert Ihre voreingestellte bzw. bevorzugte Sprache.<br />
					<strong className="adsimple-312016962">Ablaufdatum: </strong>nach Sitzungsende</p>
				<p>
					<strong className="adsimple-312016962">Name: </strong>guest_id<br />
					<strong className="adsimple-312016962">Wert: </strong>312016962v1%3A157132626<br />
					<strong className="adsimple-312016962">Verwendungszweck: </strong>Dieses Cookie wird gesetzt, um Sie als Gast zu identifizieren.<strong className="adsimple-312016962"> </strong>
					<br />
					<strong className="adsimple-312016962">Ablaufdatum: </strong>nach 2 Jahren</p>
				<p>
					<strong className="adsimple-312016962">Name: </strong>fm<br />
					<strong className="adsimple-312016962">Wert: </strong>0<br />
					<strong className="adsimple-312016962">Verwendungszweck: </strong>Zu diesem Cookie konnten wir leider den Verwendungszweck nicht in Erfahrung bringen.<br />
					<strong className="adsimple-312016962">Ablaufdatum: </strong>nach Sitzungsende</p>
				<p>
					<strong className="adsimple-312016962">Name: </strong>external_referer<br />
					<strong className="adsimple-312016962">Wert: </strong>3120169622beTA0sf5lkMrlGt<br />
					<strong className="adsimple-312016962">Verwendungszweck: </strong>Dieses Cookie sammelt anonyme Daten, wie zum Beispiel wie oft Sie Twitter besuchen und wie lange Sie Twitter besuchen.<br />
					<strong className="adsimple-312016962">Ablaufdatum: </strong>Nach 6 Tagen</p>
				<p>
					<strong className="adsimple-312016962">Name: </strong>eu_cn<br />
					<strong className="adsimple-312016962">Wert: </strong>1<br />
					<strong className="adsimple-312016962">Verwendungszweck: </strong>Dieses Cookie speichert Useraktivität und dient diversen Werbezwecken von Twitter. <strong className="adsimple-312016962">
						<br />
						Ablaufdatum: </strong>Nach einem Jahr</p>
				<p>
					<strong className="adsimple-312016962">Name: </strong>ct0<br />
					<strong className="adsimple-312016962">Wert: </strong>c1179f07163a365d2ed7aad84c99d966<br />
					<strong className="adsimple-312016962">Verwendungszweck: </strong>Zu diesem Cookie haben wir leider keine Informationen gefunden.<br />
					<strong className="adsimple-312016962">Ablaufdatum: </strong>nach 6 Stunden</p>
				<p>
					<strong className="adsimple-312016962">Name: </strong>_twitter_sess<br />
					<strong className="adsimple-312016962">Wert: </strong>53D%253D&#8211;dd0248312016962-<br />
					<strong className="adsimple-312016962">Verwendungszweck: </strong>Mit diesem Cookie können Sie Funktionen innerhalb der Twitter-Webseite nutzen.<br />
					<strong className="adsimple-312016962">Ablaufdatum: </strong>nach Sitzungsende</p>
				<p>
					<strong className="adsimple-312016962">Anmerkung:</strong> Twitter arbeitet auch mit Drittanbietern zusammen. Darum haben wir bei unserem Test auch die drei Google-Analytics-Cookies _ga, _gat, _gid erkannt.</p>
				...
				<h3 className="adsimple-312016962">Wie lange und wo werden die Daten gespeichert?</h3>
				...
				<h3 className="adsimple-312016962">Wie kann ich meine Daten löschen bzw. die Datenspeicherung verhindern?</h3>
				...
				<p>Wenn Sie kein Twitter-Konto besitzen, können Sie auf <a className="adsimple-312016962" href="https://twitter.com/">twitter.com</a> gehen und dann auf „Individualisierung“ klicken. Unter dem Punkt „Individualisierung und Daten“ können Sie Ihre erhobenen Daten verwalten.</p>
				...
				<p>Twitter verwendet die Daten auch für personalisierte Werbung in- und außerhalb von Twitter. In den Einstellungen können Sie unter „Individualisierung und Daten“ die personalisierte Werbung abschalten. Wenn Sie Twitter auf einem Browser nutzen, können Sie die personalisierte Werbung unter <a className="adsimple-312016962" href="https://optout.aboutads.info/?c=2&amp;lang=EN">https://optout.aboutads.info/?c=2&amp;lang=EN</a> deaktivieren.</p>
				<h3 className="adsimple-312016962">Rechtsgrundlage</h3>
				<p>Wenn Sie eingewilligt haben, dass Daten von Ihnen durch eingebundene Social-Media-Elemente verarbeitet und gespeichert werden können, gilt diese Einwilligung als Rechtsgrundlage der Datenverarbeitung <strong className="adsimple-312016962">(Art. 6 Abs. 1 lit. a DSGVO)</strong>. Grundsätzlich werden Ihre Daten auch auf Grundlage unseres berechtigten Interesses <strong className="adsimple-312016962">(Art. 6 Abs. 1 lit. f DSGVO)</strong> an einer schnellen und guten Kommunikation mit Ihnen oder anderen Kunden und Geschäftspartnern gespeichert und verarbeitet. Wir setzen die eingebundene Social-Media-Elemente gleichwohl nur ein, soweit Sie eine Einwilligung erteilt haben. Die meisten Social-Media-Plattformen setzen auch Cookies in Ihrem Browser, um Daten zu speichern. Darum empfehlen wir Ihnen, unseren Datenschutztext über Cookies genau durchzulesen und die Datenschutzerklärung oder die Cookie-Richtlinien des jeweiligen Dienstanbieters anzusehen.</p>
				<p>Twitter verarbeitet Daten von Ihnen u.a. auch in den USA. Wir weisen darauf hin, dass nach Meinung des Europäischen Gerichtshofs derzeit kein angemessenes Schutzniveau für den Datentransfer in die USA besteht. Dies kann mit verschiedenen Risiken für die Rechtmäßigkeit und Sicherheit der Datenverarbeitung einhergehen.</p>
				<p>Als Grundlage der Datenverarbeitung bei Empfängern mit Sitz in Drittstaaten (außerhalb der Europäischen Union, Island, Liechtenstein, Norwegen, also insbesondere in den USA) oder einer Datenweitergabe dorthin verwendet Twitter sogenannte Standardvertragsklauseln (= Art. 46. Abs. 2 und 3 DSGVO). Standardvertragsklauseln (Standard Contractual Clauses – SCC) sind von der EU-Kommission bereitgestellte Mustervorlagen und sollen sicherstellen, dass Ihre Daten auch dann den europäischen Datenschutzstandards entsprechen, wenn diese in Drittländer (wie beispielsweise in die USA) überliefert und dort gespeichert werden. Durch diese Klauseln verpflichtet sich Twitter, bei der Verarbeitung Ihrer relevanten Daten, das europäische Datenschutzniveau einzuhalten, selbst wenn die Daten in den USA gespeichert, verarbeitet und verwaltet werden. Diese Klauseln basieren auf einem Durchführungsbeschluss der EU-Kommission. Sie finden den Beschluss und die entsprechenden Standardvertragsklauseln u.a. hier: <a className="adsimple-312016962" href="https://eur-lex.europa.eu/eli/dec_impl/2021/914/oj?locale=de" target="_blank" rel="follow noreferrer noopener">https://eur-lex.europa.eu/eli/dec_impl/2021/914/oj?locale=de</a>
				</p>
				<p>Mehr Informationen zu den Standardvertragsklauseln bei Twitter finden Sie unter <a className="adsimple-312016962" href="https://gdpr.twitter.com/en/controller-to-controller-transfers.html" target="_blank" rel="follow noreferrer noopener">https://gdpr.twitter.com/en/controller-to-controller-transfers.html</a>.</p>
				<p>Wir hoffen, wir haben Ihnen einen grundsätzlichen Überblick über die Datenverarbeitung durch Twitter gegeben. Wir erhalten keinen Daten von Twitter und tragen auch keine Verantwortung darüber, was Twitter mit Ihren Daten macht. Falls Sie noch weitere Fragen zu diesem Thema haben, empfehlen wir Ihnen die Twitter-Datenschutzerklärung unter <a className="adsimple-312016962" href="https://twitter.com/de/privacy">https://twitter.com/de/privacy</a>.</p>
				<h2 id="externe-onlineplattformen-einleitung" className="adsimple-312016962">Externe Onlineplattformen Einleitung</h2>
				<table border="1" cellPadding="15">
					<tbody>
						<tr>
							<td>
								<strong className="adsimple-312016962">Externe Onlineplattformen Datenschutzerklärung Zusammenfassung</strong>
								<br />
				...
				<h3 className="adsimple-312016962">Was sind externe Onlineplattformen?</h3>
				...
				<h3 className="adsimple-312016962">Warum nutzen wir externe Onlineplattformen?</h3>
				...
				<h3 className="adsimple-312016962">Dauer der Datenverarbeitung</h3>
				...
				<h3 className="adsimple-312016962">Rechtsgrundlage</h3>
				<p>Wenn Sie eingewilligt haben, dass Daten von Ihnen durch externe Plattformen verarbeitet und gespeichert werden können, gilt diese <strong className="adsimple-312016962">Einwilligung</strong> als Rechtsgrundlage der Datenverarbeitung <strong className="adsimple-312016962">(Art. 6 Abs. 1 lit. a DSGVO)</strong>. Grundsätzlich werden Ihre Daten bei Vorliegen einer Einwilligung auch auf Grundlage eines <strong className="adsimple-312016962">berechtigten Interesses (Art. 6 Abs. 1 lit. f DSGVO)</strong> an einer schnellen und guten Kommunikation mit Ihnen oder anderen Kunden und Geschäftspartnern gespeichert und verarbeitet. Falls wir eingebundene Elemente externer Plattformen auf unser Website haben, setzen wir diese gleichwohl nur ein, soweit Sie eine Einwilligung erteilt haben.</p>
				<p>Informationen zu speziellen externen Plattformen erfahren Sie &#8211; sofern vorhanden &#8211; in den folgenden Abschnitten.</p>
				<h2 id="amazon-europe-datenschutzerklaerung" className="adsimple-312016962">Amazon (Europe) Datenschutzerklärung</h2>
				<p>Wir nutzen auch die Online-Handelsplattform Amazon (Europe). Dienstanbieter ist das amerikanische Unternehmen Amazon Inc. Für den europäischen Raum ist das Unternehmen Amazon Europe Core S.à r.l. (Société à responsabilité limitée), 38 avenue John F. Kennedy, L-1855 Luxemburg verantwortlich.</p>
				<p>Amazon verarbeitet Daten von Ihnen u.a. auch in den USA. Wir weisen darauf hin, dass nach Meinung des Europäischen Gerichtshofs derzeit kein angemessenes Schutzniveau für den Datentransfer in die USA besteht. Dies kann mit verschiedenen Risiken für die Rechtmäßigkeit und Sicherheit der Datenverarbeitung einhergehen.</p>
				<p>Als Grundlage der Datenverarbeitung bei Empfängern mit Sitz in Drittstaaten (außerhalb der Europäischen Union, Island, Liechtenstein, Norwegen, also insbesondere in den USA) oder einer Datenweitergabe dorthin verwendet Amazon sogenannte Standardvertragsklauseln (= Art. 46. Abs. 2 und 3 DSGVO). Standardvertragsklauseln (Standard Contractual Clauses – SCC) sind von der EU-Kommission bereitgestellte Mustervorlagen und sollen sicherstellen, dass Ihre Daten auch dann den europäischen Datenschutzstandards entsprechen, wenn diese in Drittländer (wie beispielsweise in die USA) überliefert und dort gespeichert werden. Durch diese Klauseln verpflichtet sich Amazon, bei der Verarbeitung Ihrer relevanten Daten, das europäische Datenschutzniveau einzuhalten, selbst wenn die Daten in den USA gespeichert, verarbeitet und verwaltet werden. Diese Klauseln basieren auf einem Durchführungsbeschluss der EU-Kommission. Sie finden den Beschluss und die entsprechenden Standardvertragsklauseln u.a. hier: <a className="adsimple-312016962" href="https://eur-lex.europa.eu/eli/dec_impl/2021/914/oj?locale=de" target="_blank" rel="follow noopener noreferrer">https://eur-lex.europa.eu/eli/dec_impl/2021/914/oj?locale=de</a>
				</p>
				<p>Die Amazon Datenverarbeitungsbedingung (AWS GDPR DATA PROCESSING), welche den Standardvertragsklauseln entsprechen, finden Sie unter <a className="adsimple-312016962" href="https://d1.awsstatic.com/legal/aws-gdpr/AWS_GDPR_DPA.pdf" target="_blank" rel="follow noreferrer noopener">https://d1.awsstatic.com/legal/aws-gdpr/AWS_GDPR_DPA.pdf</a>.</p>
				<p>Mehr über die Daten, die durch die Verwendung von Amazon verarbeitet werden, erfahren Sie in der Datenschutzerklärung auf <a className="adsimple-312016962" href="https://www.amazon.de/gp/help/customer/display.html?nodeId=201909010&amp;ref_=footer_privacy" target="_blank" rel="follow  noreferrer noopener">https://www.amazon.de/gp/help/customer/display.html?nodeId=201909010&amp;ref_=footer_privacy</a>
					<u>.</u>
				</p>
				<h2 id="audio-video-einleitung" className="adsimple-312016962">Audio &amp; Video Einleitung</h2>
				<table border="1" cellPadding="15">
					<tbody>
						<tr>
							<td>
								<strong className="adsimple-312016962">Audio &amp; Video Datenschutzerklärung Zusammenfassung</strong>
								<br />
								&#x1f465; Betroffene: Besucher der Website<br />
								&#x1f91d; Zweck: Optimierung unserer Serviceleistung<br />
				...
				<h3 className="adsimple-312016962">Was sind Audio- und Videoelemente?</h3>
				...
				<h3 className="adsimple-312016962">Warum verwenden wir Audio- &amp; Videoelemente auf unserer Website?</h3>
				...
				<h3 className="adsimple-312016962">Welche Daten werden durch Audio- &amp; Videoelemente gespeichert?</h3>
				...
				<h3 className="adsimple-312016962">
					<strong className="adsimple-312016962">Rechtsgrundlage</strong>
				</h3>
				<p>Wenn Sie eingewilligt haben, dass Daten von Ihnen durch eingebundene Audio- und Video-Elemente verarbeitet und gespeichert werden können, gilt diese Einwilligung als Rechtsgrundlage der Datenverarbeitung <strong className="adsimple-312016962">(Art. 6 Abs. 1 lit. a DSGVO)</strong>. Grundsätzlich werden Ihre Daten auch auf Grundlage unseres berechtigten Interesses <strong className="adsimple-312016962">(Art. 6 Abs. 1 lit. f DSGVO)</strong> an einer schnellen und guten Kommunikation mit Ihnen oder anderen Kunden und Geschäftspartnern gespeichert und verarbeitet. Wir setzen die eingebundenen Audio- und Video-Elemente gleichwohl nur ein, soweit Sie eine Einwilligung erteilt haben.</p>
				<h2 id="youtube-datenschutzerklaerung" className="adsimple-312016962">YouTube Datenschutzerklärung</h2>
				<table border="1" cellPadding="15">
					<tbody>
						<tr>
							<td>
								<strong className="adsimple-312016962">YouTube Datenschutzerklärung Zusammenfassung</strong>
								<br />
								&#x1f465; Betroffene: Besucher der Website<br />
								&#x1f91d; Zweck: Optimierung unserer Serviceleistung<br />
								&#x1f4d3; Verarbeitete Daten: Daten wie etwa Kontaktdaten, Daten zum Nutzerverhalten, Informationen zu Ihrem Gerät und Ihre IP-Adresse können gespeichert werden.<br />
				...
				<h3 className="adsimple-312016962">Was ist YouTube?</h3>
				...
				<h3 className="adsimple-312016962">Warum verwenden wir YouTube-Videos auf unserer Website?</h3>
				...
				<h3 className="adsimple-312016962">Welche Daten werden von YouTube gespeichert?</h3>
				...
				<p>
					<strong className="adsimple-312016962">Name:</strong> YSC<br />
					<strong className="adsimple-312016962">Wert:</strong> b9-CV6ojI5Y312016962-1<br />
					<strong className="adsimple-312016962">Verwendungszweck:</strong> Dieses Cookie registriert eine eindeutige ID, um Statistiken des gesehenen Videos zu speichern.<br />
					<strong className="adsimple-312016962">Ablaufdatum:</strong> nach Sitzungsende</p>
				<p>
					<strong className="adsimple-312016962">Name:</strong> PREF<br />
					<strong className="adsimple-312016962">Wert:</strong> f1=50000000<br />
					<strong className="adsimple-312016962">Verwendungszweck:</strong> Dieses Cookie registriert ebenfalls Ihre eindeutige ID. Google bekommt über PREF Statistiken, wie Sie YouTube-Videos auf unserer Webseite verwenden.<br />
					<strong className="adsimple-312016962">Ablaufdatum:</strong> nach 8 Monaten</p>
				<p>
					<strong className="adsimple-312016962">Name:</strong> GPS<br />
					<strong className="adsimple-312016962">Wert:</strong> 1<br />
					<strong className="adsimple-312016962">Verwendungszweck:</strong> Dieses Cookie registriert Ihre eindeutige ID auf mobilen Geräten, um den GPS-Standort zu tracken.<br />
					<strong className="adsimple-312016962">Ablaufdatum:</strong> nach 30 Minuten</p>
				<p>
					<strong className="adsimple-312016962">Name:</strong> VISITOR_INFO1_LIVE<br />
					<strong className="adsimple-312016962">Wert:</strong> 95Chz8bagyU<br />
					<strong className="adsimple-312016962">Verwendungszweck:</strong> Dieses Cookie versucht die Bandbreite des Users auf unseren Webseiten (mit eingebautem YouTube-Video) zu schätzen.<br />
					<strong className="adsimple-312016962">Ablaufdatum:</strong> nach 8 Monaten</p>
				<p>Weitere Cookies, die gesetzt werden, wenn Sie mit Ihrem YouTube-Konto angemeldet sind:</p>
				<p>
					<strong className="adsimple-312016962">Name:</strong> APISID<br />
					<strong className="adsimple-312016962">Wert:</strong> zILlvClZSkqGsSwI/AU1aZI6HY7312016962-<br />
					<strong className="adsimple-312016962">Verwendungszweck:</strong> Dieses Cookie wird verwendet, um ein Profil über Ihre Interessen zu erstellen. Genützt werden die Daten für personalisierte Werbeanzeigen.<br />
					<strong className="adsimple-312016962">Ablaufdatum:</strong> nach 2 Jahren</p>
				<p>
					<strong className="adsimple-312016962">Name:</strong> CONSENT<br />
					<strong className="adsimple-312016962">Wert:</strong> YES+AT.de+20150628-20-0<br />
					<strong className="adsimple-312016962">Verwendungszweck:</strong> Das Cookie speichert den Status der Zustimmung eines Users zur Nutzung unterschiedlicher Services von Google. CONSENT dient auch der Sicherheit, um User zu überprüfen und Userdaten vor unbefugten Angriffen zu schützen.<br />
					<strong className="adsimple-312016962">Ablaufdatum: </strong>nach 19 Jahren</p>
				<p>
					<strong className="adsimple-312016962">Name:</strong> HSID<br />
					<strong className="adsimple-312016962">Wert:</strong> AcRwpgUik9Dveht0I<br />
					<strong className="adsimple-312016962">Verwendungszweck:</strong> Dieses Cookie wird verwendet, um ein Profil über Ihre Interessen zu erstellen. Diese Daten helfen personalisierte Werbung anzeigen zu können.<br />
					<strong className="adsimple-312016962">Ablaufdatum:</strong> nach 2 Jahren</p>
				<p>
					<strong className="adsimple-312016962">Name:</strong> LOGIN_INFO<br />
					<strong className="adsimple-312016962">Wert:</strong> AFmmF2swRQIhALl6aL…<br />
					<strong className="adsimple-312016962">Verwendungszweck:</strong> In diesem Cookie werden Informationen über Ihre Login-Daten gespeichert.<br />
					<strong className="adsimple-312016962">Ablaufdatum:</strong> nach 2 Jahren</p>
				<p>
					<strong className="adsimple-312016962">Name:</strong> SAPISID<br />
					<strong className="adsimple-312016962">Wert:</strong> 7oaPxoG-pZsJuuF5/AnUdDUIsJ9iJz2vdM<br />
					<strong className="adsimple-312016962">Verwendungszweck:</strong> Dieses Cookie funktioniert, indem es Ihren Browser und Ihr Gerät eindeutig identifiziert. Es wird verwendet, um ein Profil über Ihre Interessen zu erstellen.<br />
					<strong className="adsimple-312016962">Ablaufdatum:</strong> nach 2 Jahren</p>
				<p>
					<strong className="adsimple-312016962">Name:</strong> SID<br />
					<strong className="adsimple-312016962">Wert:</strong> oQfNKjAsI312016962-<br />
					<strong className="adsimple-312016962">Verwendungszweck:</strong> Dieses Cookie speichert Ihre Google-Konto-ID und Ihren letzten Anmeldezeitpunkt in digital signierter und verschlüsselter Form.<br />
					<strong className="adsimple-312016962">Ablaufdatum:</strong> nach 2 Jahren</p>
				<p>
					<strong className="adsimple-312016962">Name:</strong> SIDCC<br />
					<strong className="adsimple-312016962">Wert:</strong> AN0-TYuqub2JOcDTyL<br />
					<strong className="adsimple-312016962">Verwendungszweck:</strong> Dieses Cookie speichert Informationen, wie Sie die Webseite nutzen und welche Werbung Sie vor dem Besuch auf unserer Seite möglicherweise gesehen haben.<br />
					<strong className="adsimple-312016962">Ablaufdatum:</strong> nach 3 Monaten</p>
				<h3 className="adsimple-312016962">Wie lange und wo werden die Daten gespeichert?</h3>
				<p>Die Daten, die YouTube von Ihnen erhält und verarbeitet werden auf den Google-Servern gespeichert. Die meisten dieser Server befinden sich in Amerika. Unter <a className="adsimple-312016962" href="https://www.google.com/about/datacenters/locations/?hl=de">https://www.google.com/about/datacenters/inside/locations/?hl=de</a>  sehen Sie genau wo sich die Google-Rechenzentren befinden. Ihre Daten sind auf den Servern verteilt. So sind die Daten schneller abrufbar und vor Manipulation besser geschützt.</p>
				...
				<h3 className="adsimple-312016962">Rechtsgrundlage</h3>
				<p>Wenn Sie eingewilligt haben, dass Daten von Ihnen durch eingebundene YouTube-Elemente verarbeitet und gespeichert werden können, gilt diese Einwilligung als Rechtsgrundlage der Datenverarbeitung <strong className="adsimple-312016962">(Art. 6 Abs. 1 lit. a DSGVO)</strong>. Grundsätzlich werden Ihre Daten auch auf Grundlage unseres berechtigten Interesses <strong className="adsimple-312016962">(Art. 6 Abs. 1 lit. f DSGVO)</strong> an einer schnellen und guten Kommunikation mit Ihnen oder anderen Kunden und Geschäftspartnern gespeichert und verarbeitet. Wir setzen die eingebundenen YouTube-Elemente gleichwohl nur ein, soweit Sie eine Einwilligung erteilt haben. YouTube setzt auch Cookies in Ihrem Browser, um Daten zu speichern. Darum empfehlen wir Ihnen, unseren Datenschutztext über Cookies genau durchzulesen und die Datenschutzerklärung oder die Cookie-Richtlinien des jeweiligen Dienstanbieters anzusehen.</p>
				<p>YouTube verarbeitet Daten u.a. auch in den USA. Wir weisen darauf hin, dass nach Meinung des Europäischen Gerichtshofs derzeit kein angemessenes Schutzniveau für den Datentransfer in die USA besteht. Dies kann mit verschiedenen Risiken für die Rechtmäßigkeit und Sicherheit der Datenverarbeitung einhergehen.</p>
				<p>Als Grundlage der Datenverarbeitung bei Empfängern mit Sitz in Drittstaaten (außerhalb der Europäischen Union, Island, Liechtenstein, Norwegen, also insbesondere in den USA) oder einer Datenweitergabe dorthin verwendet YouTube von der EU-Kommission genehmigte Standardvertragsklauseln (= Art. 46. Abs. 2 und 3 DSGVO). Diese Klauseln verpflichten YouTube, das EU-Datenschutzniveau bei der Verarbeitung relevanter Daten auch außerhalb der EU einzuhalten. Diese Klauseln basieren auf einem Durchführungsbeschluss der EU-Kommission. Sie finden den Beschluss sowie die Klauseln u.a. hier: <a className="adsimple-312016962" href="https://germany.representation.ec.europa.eu/index_de" target="_blank" rel="follow noreferrer noopener">https://germany.representation.ec.europa.eu/index_de</a>.</p>
				<p>Da YouTube ein Tochterunternehmen von Google ist, gibt es eine gemeinsame Datenschutzerklärung. Wenn Sie mehr über den Umgang mit Ihren Daten erfahren wollen, empfehlen wir Ihnen die Datenschutzerklärung unter <a className="adsimple-312016962" href="https://policies.google.com/privacy?hl=de" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy?hl=de.</a>
				</p>
				<h2 id="videokonferenzen-streaming-einleitung" className="adsimple-312016962">Videokonferenzen &amp; Streaming Einleitung</h2>
				<table border="1" cellPadding="15">
					<tbody>
						<tr>
							<td>
								<strong className="adsimple-312016962">Videokonferenzen &amp; Streaming Datenschutzerklärung Zusammenfassung</strong>
								<br />
				...
				<h3 className="adsimple-312016962">Was sind Videokonferenzen &amp; Streamings?</h3>
				...
				<h3 className="adsimple-312016962">Warum verwenden wir Videokonferenzen &amp; Streaming auf unserer Website?</h3>
				...
				<h3 className="adsimple-312016962">Rechtsgrundlage</h3>
				<p>Wenn Sie eingewilligt haben, dass Daten von Ihnen durch die Video bzw. Streaming-Lösung verarbeitet und gespeichert werden können, gilt diese Einwilligung als Rechtsgrundlage der Datenverarbeitung <strong className="adsimple-312016962">(Art. 6 Abs. 1 lit. a DSGVO)</strong>. Zudem können wir auch eine Videokonferenz als Teil unserer Services anbieten, wenn dies im Vorfeld mit Ihnen vertraglich vereinbart wurde <strong className="adsimple-312016962">(Art. 6 Abs. 1 lit. b DSGVO)</strong>. Grundsätzlich werden Ihre Daten auch auf Grundlage unseres berechtigten Interesses <strong className="adsimple-312016962">(Art. 6 Abs. 1 lit. f DSGVO)</strong> an einer schnellen und guten Kommunikation mit Ihnen oder anderen Kunden und Geschäftspartnern gespeichert und verarbeitet, jedoch nur, soweit Sie zumindest eingewilligt haben. Die meisten Video- bzw. Streaming-Lösungen setzen auch Cookies in Ihrem Browser, um Daten zu speichern. Darum empfehlen wir Ihnen, unseren Datenschutztext über Cookies genau durchzulesen und die Datenschutzerklärung oder die Cookie-Richtlinien des jeweiligen Dienstanbieters anzusehen.</p>
				...
				<h2 id="twitch-datenschutzerklaerung" className="adsimple-312016962">Twitch Datenschutzerklärung</h2>
				...
				<p>Mehr über die Daten, die durch die Verwendung von Twitch verarbeitet werden, erfahren Sie in der Privacy Policy auf<u> <a className="adsimple-312016962" href="https://www.twitch.tv/p/de-de/legal/privacy-notice/" target="_blank" rel="noopener noreferrer">https://www.twitch.tv/p/de-de/legal/privacy-notice/</a>. </u>
				</p>
